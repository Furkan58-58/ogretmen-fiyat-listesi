...
function openCatalog(catalog) {
  ...
  $("#home-view").hidden = true; $("#catalog-view").hidden = false; $("#catalog-actions").hidden = false; $("#back-home").hidden = false; $("#pdf-link").href = catalog.pdf;
